    ...
    return (
        <nav className="flex flex-col bg-purple-900 w-64 min-h-screen px-4 tex-gray-900 border border-purple-900">
            <div className="flex flex-wrap mt-8">
                <div className="w-1/2">
                    <img
                        src="https://newstyle-mag.com/wp-content/uploads/2017/02/232.jpg"
                        className="mx-auto w-20 h-20 rounded-full"
                    />
                </div>
                <div className="w-1/2">
                    <span className="font-semibold text-white">Albert Einstein</span>
                </div>
            </div>
            <div className="mt-10 mb-4">
                <ul className="ml-4">
                    <li className="px-4 mb-6 text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:font-bold rounded rounded-lg">
              <span>
